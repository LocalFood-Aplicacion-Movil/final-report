...
A continuación, se presenta el logo de NearbyEats:

![Logo-NearbyEats.PNG](../../assets/chapter-3/Logo-NearbyEats.PNG)

#### Typography

La tipografía en **NearbyEats** juega un papel crucial en la claridad y coherencia de la interfaz.  
...
La elección de colores es una parte esencial en el diseño de **NearbyEats**. Una paleta bien definida no solo determina la estética de la marca, sino que también comunica los valores principales de frescura, accesibilidad y confianza.
...
En esta sección se detallan las decisiones y fundamentos que guían la organización del contenido en las experiencias web y móvil de **NearbyEats**, incluyendo tanto la Landing Page como la Aplicación Web. Estas propuestas buscan asegurar que los usuarios se adapten fácilmente a la funcionalidad de la plataforma y encuentren lo que necesitan sin esfuerzo. Las decisiones abarcan los sistemas de organización, etiquetado, SEO, búsqueda y navegación.

---
#### 3.1.2.1. Organization Systems

Para estructurar la arquitectura de información de **NearbyEats**, se ha adoptado un sistema **jerárquico** en la Landing Page y en la Aplicación Web. Esto permite a los usuarios identificar rápidamente las secciones principales y acceder a las funcionalidades clave.

### Landing Page

La Landing Page de **NearbyEats** incluye las siguientes secciones:
...
El sistema de etiquetado en **NearbyEats** está diseñado para ser **claro, inclusivo y coherente**.
...
- **Title:**
  ...
  ```html
     <title>NearbyEats - Encuentra tu punto medio en Lima</title>
- **Description:**

  ```html
    <meta name="description" content="NearbyEats es una aplicación que recomienda restaurantes y cafés equitativos para grupos de amigos y colegas en Lima, utilizando geolocalización inteligente."/>
- **Keywords:**

  ```html
    <meta name="keywords" content="NearbyEats, punto medio, app reuniones, restaurantes accesibles, Lima"/>
- **Author:**

  ```html
  <meta name="author" content="© 2024 NearbyEats. Todos los derechos reservados."/>
- **Viewport:**
...
El sistema de navegación en **NearbyEats** está diseñado para ser **intuitivo y consistente** en web y móvil:
...
**Introducción:**  
La landing page de NearbyEats refleja los valores de equidad, frescura y eficiencia. La estructura guía al usuario de manera clara hacia los beneficios y el uso inmediato de la app.
